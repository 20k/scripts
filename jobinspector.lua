...
function dump_job(j)
	...
	imgui.Text("id", tostring(j.id))
	imgui.Text("Posting", tostring(j.posting_index))
	imgui.Text("Pos", tostring(j.pos.x), tostring(j.pos.y), tostring(j.pos.z))
	imgui.Text("Comptimer", tostring(j.completion_timer))
	imgui.Text("Unk4", j.unk4)
	imgui.Text("Unk5", j.unk5)
	imgui.Text("Unk11", j.unk11)
	imgui.Text("orderid", j.order_id)
